...
SHA-256: `b6583c34a56aad63b4ee8cc88ca05890844cdabebb62e3e59a349414973c71cb`

Automated qualification completed on Windows 10, August 17, 2026:
...
- packaged Pillow image-engine control: PASS
- project creation and GP29 Result: PASS
- bounded GP29 experiment: PASS
...
- embedded Atlas source UAT with a 75-page local carrier, fit, zoom, selection, and rendering: PASS
- Microsoft Defender scans of the ZIP and both executables: NO THREATS with Defender enabled
...
4. Link a local 75-page corpus folder. In LP Atlas, confirm all 75 pages are selectable and test embedded rendering, Previous/Next, Fit, zoom, drag-to-pan, and optional external opening.
