...
from scripts.endeavour_lite_app import VERSION, packaged_self_test
...
def main(argv: list[str] | None = None) -> int:
    ...
    except (ProjectError, GP29InputError, CorpusManifestError, OSError, UnicodeError, json.JSONDecodeError, ValueError) as error:
