...
| Corpus Manifest Verifier | RELEASE CANDIDATE — 0.1.0-rc.3 | Developer source and private qualification package; no customer download | Observer |
| Public GP29 Calculator | RELEASED — 0.1.1 | Public Windows desktop/CLI download with approved manifest and checksums | Observer |
| HMS Endeavour Runtime Environment | RELEASE CANDIDATE — 1.0.0-rc.1 | Page-aware local workstation and qualified Windows RC; final visual UAT and owner approval pending | Observer |
...
The validator and source-audit inventory were released in `v0.1.0` specifically as developer tools. They require CPython and are not customer-ready applications. GP29 v0.1.1 is the first released customer-ready Windows instrument. The HMS Endeavour Runtime Environment is the local workstation release candidate; a future hosted Liber Runtime is a distinct planned service. Expedition 001 remains closed until its packaged verifier passes the customer release gate.
