...
Two local clean builds were byte-identical. The exact package passed internal checksums, both packaged self-tests, all five synthetic cases, strict verification of the bound 75-page local set, the focused 15-test verifier/package suite, and Microsoft Defender scanning. Independent GitHub qualification, clean-environment human UAT, and explicit owner approval remain required.
