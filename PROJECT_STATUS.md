...
- Expedition verifier: the v0.2.0 offline candidate was rejected after its five-letter digest failed the solution-leak audit. The v0.3.0 sealed-service redesign is in development; no endpoint or customer download is public, and the campaign remains closed.
