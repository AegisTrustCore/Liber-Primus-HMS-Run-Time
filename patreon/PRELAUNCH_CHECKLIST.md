# Patreon Pre-launch Checklist

The creator page was published on 2026-08-12 after tier names, shared benefits, descriptions, and planned-capability labels were corrected.
...
- [ ] Confirm the public creator URL works in a signed-out browser.
- [ ] Add the live Patreon link to the GitHub README.
- [ ] Add GitHub, documentation, research-record, roadmap, and application links to Patreon.
- [x] Record the Patreon publication date in `CHANGELOG.md`.

## Completed launch actions

- [x] Published the public orientation post.
- [x] Published Pilgrim Briefing 001 for all paid tiers.
- [x] Published Navigator Research Queue 001 for Navigator, Cartographer, and Admiral.
- [x] Published Cartographer Evidence Ledger 001 for Cartographer and Admiral.
- [x] Published Admiral Frontier Boundary 001 for Admiral only.
