...
- [Staged OutGuess closure 003](research/runsets/RSET-0003/START-HERE.md) — E1059 ledger verification and bounded default-key branch closure awaiting approval
...
| Research Archive | **PUBLISHED ON `main` — 8 Runs, 8 Results, 3 Capsules; RSET-0001 and RSET-0003 staged, RSET-0002 published** |
...
The public foundation currently distributes developer-source utilities and portable research packages, not customer applications. [RSET-0001](research/runsets/RSET-0001/README.md) and [RSET-0003](research/runsets/RSET-0003/START-HERE.md) are staged review packages; [RSET-0002](research/runsets/RSET-0002/START-HERE.md) is a published source-tree release. The first Windows puzzle-verifier package remains private until Expedition 001 receives its own release approval.
